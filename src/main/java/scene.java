...
public class scene extends class218 {
	...
	public static final void method282(double arg0, byte arg1) {
		if (class214.field4043 != arg0) {
			for (int var3 = 0; ~var3 > -257; ++var3) {
				...
				IfType.field3509[var3] = var4 <= 255 ? var4 : 255;
			}
		...
		if (arg1) {
			...
			for (int var8 = 0; ~var8 > -13; ++var8) {
				...
				if (var9 == 0) {
					...
					if (~var11 <= -32769) {
						int var15 = CollisionMap.field1699[var11 + -32768];
	...
	private void method286(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, class30 arg10, int arg11, int arg12) {
		++field742;
