...
public class class185 {
    ...
    public final void method1307(Packet arg0, class235 arg1) {
        ...
        this.field3619[0] = arg0.g2();
        this.field3619[1] = arg0.g2();
        int var4 = arg0.g1();
        for (int var5 = 0; var5 < 2; var5++) {
            for (int var8 = 0; var8 < this.field3622[var5]; var8++) {
                this.field3616[var5][0][var8] = arg0.g2();
                this.field3618[var5][0][var8] = arg0.g2();
            }
        }
        for (int var6 = 0; var6 < 2; var6++) {
            for (int var7 = 0; var7 < this.field3622[var6]; var7++) {
                if ((var4 & 0x1 << var6 * 4 << var7) == 0) {
                    ...
                    this.field3616[var6][1][var7] = arg0.g2();
                    this.field3618[var6][1][var7] = arg0.g2();
                }
            }
        }
