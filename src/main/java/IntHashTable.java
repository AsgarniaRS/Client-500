...
public class IntHashTable {
	...
	public static JString field1804 = class208.method1425("Hidden)2");
	...
	private static JString field1815 = class208.method1425("Starting 3d library");

	@OriginalMember(owner = "client!ja", name = "k", descriptor = "Li;")
	public static JString field1814 = field1815;
		...
		if (class231.field4335 == 0 && class203.field3878 == 0 && class220.pendingPrefetchQueueSize == 0 && class208.pendingUrgentQueueSize == 0) {
			...
			try {
				...
				for (int var8 = 0; var8 < 100; var8++) {
					...
					if (var10 > 0) {
						int var11 = var10 - class78.field1408.pos;
						if (var9 < var11) {
							var11 = var9;
						}
			...
			if (arg0 == -27 && class156.field3018 == 0) {
				if (class203.field3869) {
					...
					if (class122.field2219 != null && GameShell.method583(0, class179.field3570) != null) {
						...
						Isaac.out.p4_alt3(class179.field3570.parentId);
						Isaac.out.p4_alt3(class122.field2219.parentId);
