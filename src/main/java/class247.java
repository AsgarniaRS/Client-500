...
public class class247 extends class136 {
    ...
    public static class88 field4518 = class208.method1425(105, "cookiehost");

    @OriginalMember(owner = "client!wh", name = "F", descriptor = "Li;")
    private static class88 field4515 = class208.method1425(105, "Unexpected server response)3");

    @OriginalMember(owner = "client!wh", name = "S", descriptor = "Li;")
    public static class88 field4526 = field4515;
    ...
    private static class88 field4531 = class208.method1425(105, "Loaded update list");

    @OriginalMember(owner = "client!wh", name = "H", descriptor = "Li;")
    public static class88 field4517 = field4531;
