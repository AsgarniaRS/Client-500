...
public class class204 extends Linkable {
	...
	public static final void method1400(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
		if (class28.field475 == 0 && !class10.field145) {
			...
			class98.method687(9746, var12, class4.field54, (short) 10, 0L, IfType.field3455, var11);
		}
		field3882++;
		long var13 = -1L;
		for (int var15 = 0; var15 < class161.field3103; var15++) {
			...
			if (var13 != var16) {
				...
				if (var20 == 1) {
					...
					if (var26.field3684.size == 1 && (var26.field4138 & 0x7F) == 64 && (var26.field4123 & 0x7F) == 64) {
						for (int var27 = 0; var27 < class55.field1041; var27++) {
							class191 var30 = class225.field4225[class25.field402[var27]];
							if (var30 != null && var26 != var30 && var30.field3684.size == 1 && var26.field4138 == var30.field4138 && var26.field4123 == var30.field4123) {
						...
						for (int var28 = 0; var28 < class55.field1027; var28++) {
							scene var29 = class244.field4493[IfType.field3430[var28]];
							if (var29 != null && var26.field4138 == var29.field4138 && var26.field4123 == var29.field4123) {
								class139.method924(IfType.field3430[var28], 31, var18, var19, var29);
							}
						}
					}
				...
				if (var20 == 0) {
					...
					if ((var31.field4138 & 0x7F) == 64 && (var31.field4123 & 0x7F) == 64) {
						for (int var32 = 0; var32 < class55.field1041; var32++) {
							...
							if (var35 != null && var35.field3684.size == 1 && var31.field4138 == var35.field4138 && var31.field4123 == var35.field4123) {
						...
						for (int var33 = 0; var33 < class55.field1027; var33++) {
							scene var34 = class244.field4493[IfType.field3430[var33]];
							if (var34 != null && var31 != var34 && var31.field4138 == var34.field4138 && var31.field4123 == var34.field4123) {
								class139.method924(IfType.field3430[var33], 31, var18, var19, var34);
							}
						}
					}
							...
							if (class28.field475 == 1) {
								...
								for (int var41 = 4; var41 >= 0; var41--) {
									if (var40 != null && var40[var41] != null) {
										...
										class98.method687(9746, var18, var40[var41], var42, (long) var38, class166.method1142(new JString[]{Linkable2.field2531, var39.field2894}, -3), var19);
									} else if (var41 == 2) {
										class98.method687(arg6 ^ 0xA9881B4F, var18, class231.field4345, (short) 41, (long) var38, class166.method1142(new JString[]{Linkable2.field2531, var39.field2894}, -3), var19);
										class43.field722++;
									}
								}
								class98.method687(9746, var18, class65.field1174, (short) 1006, (long) var38, class166.method1142(new JString[]{Linkable2.field2531, var39.field2894}, -3), var19);
