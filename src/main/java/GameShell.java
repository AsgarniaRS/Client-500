...
public abstract class GameShell extends Applet implements Runnable, FocusListener, WindowListener {
	...
	public static JString field1573 = class208.method1425("W-=hlen Sie eine Welt");

	@OriginalMember(owner = "client!hj", name = "G", descriptor = "Li;")
	private static JString field1590 = class208.method1425("go back to the main RuneScape webpage");
	...
	private void method584(byte arg0) {
	...
	private synchronized void method585(byte arg0) {
		field1571++;
		Container var2;
		if (class201.field3834 == null) {
	...
	private void method587(int arg0, boolean arg1) {
		field1593++;
		synchronized (this) {
			if (class48.field909) {
				return;
	...
	private void method589(int arg0) {
		field1587++;
		long var2 = class206.method1420(false);
