...
public abstract class class130 {
	...
	public static final class129 method880(int arg0, int arg1) {
		field2437++;
		class129 var2 = (class129) class210.field3991.find((long) arg0);
		if (var2 != null) {
			return var2;
		}
		class129 var3 = Packet.method309(LocType.field2780, arg0, class142.field2626, false, (byte) -122);
		if (var3 != null) {
			class210.field3991.put(var3, (long) arg0, false);
		}
		return var3;
	}
