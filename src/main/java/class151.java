...
public class class151 {
	...
	private HashTable field2930 = new HashTable(256);
	...
	private class213 method1035(int[] arg0, int arg1, int arg2, int arg3) {
		field2932++;
		int var5 = arg3 ^ ((arg1 & 0xD0000FFF) << 4 | arg1 >>> 12);
		int var6 = var5 | arg1 << 16;
		long var7 = (long) var6 ^ 0x100000000L;
		class213 var9 = (class213) this.field2939.find(var7);
		if (arg2 != -41513424) {
		...
		if (var9 != null) {
			...
			class195 var10 = (class195) this.field2930.find(var7);
			if (var10 == null) {
	...
	private class213 method1036(int arg0, int arg1, int[] arg2, int arg3) {
		field2929++;
		if (arg0 != -1673520700) {
			urgentQueue = null;
		}
