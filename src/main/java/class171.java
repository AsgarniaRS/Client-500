...
public class class171 extends class23 {
	...
	private static JString field3326 = class208.method1425("Bad session id)3");

	@OriginalMember(owner = "client!ph", name = "V", descriptor = "Li;")
	private static JString field3327 = class208.method1425(" has logged in)3");
	...
	public static JString[] stringStack = new JString[1000];
