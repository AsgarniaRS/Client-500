...
public class class110 {
	...
	private static JString field2008 = class208.method1425("You have only just left another world)3");

	@OriginalMember(owner = "client!ka", name = "e", descriptor = "I")
	public static int field2011 = -1;

	@OriginalMember(owner = "client!ka", name = "c", descriptor = "Li;")
	public static JString field2009 = class208.method1425("k");
