...
public class class186 extends class23 {
	...
	public static final void method1309(boolean arg0) {
		...
		if (HashTable.field2971 > 0) {
			for (int var2 = 0; var2 < 256; ++var2) {
				if (~HashTable.field2971 >= -769) {
					if (HashTable.field2971 <= 256) {
						class157.field3036[var2] = class228.method1527(class3.field32[var2], -HashTable.field2971 + 256, (byte) -38, class15.field234[var2]);
					} else {
						class157.field3036[var2] = class15.field234[var2];
					}
				} else {
					class157.field3036[var2] = class228.method1527(class15.field234[var2], -HashTable.field2971 + 1024, (byte) -38, class3.field32[var2]);
				}
			}
	...
	private void method1310(Random arg0, int[][] arg1, int arg2, int arg3, int arg4, boolean arg5, int arg6) {
		++field3627;
