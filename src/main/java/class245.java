...
public class class245 {
	...
	public static final void method1606(int arg0) {
		field4501++;
		int var1 = NpcType.field2332 - (int) ((double) class90.field1707.field3382 / GZip.field1110);
		int var2 = class157.field3035 - (int) ((double) class90.field1707.field3424 / GZip.field1110);
		int var3 = NpcType.field2332 + (int) ((double) class90.field1707.field3382 / GZip.field1110);
		if (arg0 > var1) {
			NpcType.field2332 = (int) ((double) class90.field1707.field3382 / GZip.field1110);
			class189.field3661 = -1;
			class34.field594 = -1;
		}
		if (SeqType.field1990 < var3) {
			NpcType.field2332 = SeqType.field1990 - (int) ((double) class90.field1707.field3382 / GZip.field1110);
			class34.field594 = -1;
			class189.field3661 = -1;
		}
