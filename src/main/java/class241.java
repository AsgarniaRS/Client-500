...
public abstract class class241 {
	...
	private static JString field4464 = class208.method1425("cyan:");

	@OriginalMember(owner = "client!wb", name = "c", descriptor = "Li;")
	public static JString field4465 = field4464;

	@OriginalMember(owner = "client!wb", name = "g", descriptor = "Li;")
	public static JString field4469 = field4464;
	...
	public static JString field4474 = class208.method1425("Begeben Sie sich in ein freies Gebiet)1 um");
	...
	public static final void method1590(IfType arg0, int arg1, int arg2, int arg3, int arg4, byte arg5, int arg6) {
		if (arg5 <= 126) {
			field4472 = null;
		}
	...
	public static final boolean method1593(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, boolean arg7, int arg8, int arg9, int arg10, int arg11, int arg12) {
		...
		int[][] var19 = class166.levelCollisionMap[class149.minusedLevel].flags;
		label372:
		while (var16 != var41) {
			...
			if (arg3 != 0) {
				if ((arg3 < 5 || arg3 == 10) && class166.levelCollisionMap[class149.minusedLevel].method641(var15, arg3 - 1, arg1, arg4, arg2, arg6, var14, arg9 - 19661241)) {
					var17 = true;
					break;
				}
				if (arg3 < 10 && class166.levelCollisionMap[class149.minusedLevel].method649(arg6, var14, arg3 - 1, (byte) 127, arg4, arg2, var15, arg1)) {
					var17 = true;
					break;
				}
			}
			if (arg0 != 0 && arg12 != 0 && class166.levelCollisionMap[class149.minusedLevel].method651(arg2, arg4, arg0, 1, var15, arg12, var14, arg1, arg11)) {
				var17 = true;
				break;
			}
