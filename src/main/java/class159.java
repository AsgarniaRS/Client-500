...
public class class159 extends Linkable {
	...
	public static JString field3076 = field3072;
	...
	public static final byte[] method1074(int arg0, int arg1) {
		...
		class189 var2 = (class189) class24.field388.find((long) arg0);
		if (var2 == null) {
			...
			class24.field388.put(var2, (long) arg0, false);
		}
