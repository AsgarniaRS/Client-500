...
public class class143 extends Linkable {
	...
	private static JString SKILL = class208.method1425("skill)2");

	@OriginalMember(owner = "client!na", name = "O", descriptor = "Li;")
	private static JString PLEASEWAIT = class208.method1425("Please wait)3)3)3");
	...
	private static JString field2661 = class208.method1425("Loaded sprites");
			...
			if (var10 != null && (!var10.v3 || var10.type == 0 || var10.hashook || class80.method530(-881710560, var10) != 0 || class49.field923 == var10 || var10.field3441 == 1338) && var10.layerId == arg4 && (!var10.v3 || !class71.method475(0, var10))) {
				...
				if (!var10.v3 || var16 < var18 && var13 < var17) {
					...
					if (var10.v3) {
						...
						if (var10.hashook || var10.field3441 != 0) {
							...
							if (var10.field3483 != null && class226.field4246 > var10.field3374) {
								if (var10.field3452 == null || class226.field4246 - var10.field3374 > 32) {
									...
									label448:
									for (int var39 = var10.field3374; var39 < class226.field4246; var39++) {
							...
							if (var10.field3445 != null && class223.field4200 > var10.field3409) {
								if (var10.field3371 == null || class223.field4200 - var10.field3409 > 32) {
									...
									label424:
									for (int var44 = var10.field3409; var44 < class223.field4200; var44++) {
					...
					if (var10.type == 0) {
						method935(var13, var18, arg2, var11 - var10.field3395, var10.parentId, var17, arg6, var16, var12 - var10.field3417);
	...
	public static final void method939(byte[] arg0, byte arg1) {
		...
		while (true) {
			while (var2 < arg0.length) {
				...
				if (var3 > 0 && var4 > 0 && var3 + 64 < SeqType.field1990 && var4 + 64 < scene.field760) {
					int var5 = var3 >> 6;
