...
public class class176 extends Linkable2 {
	...
	private static JString field3540 = class208.method1425("Members object");
	...
	private void method1262(int arg0, int arg1, Packet arg2) {
		if (arg0 == arg1) {
			int var4 = arg2.g1();
			if (this.field3541 == null) {
				int var5 = class184.method1298(true, var4);
				this.field3541 = new HashTable(var5);
			}
			for (int var6 = 0; var6 < var4; var6++) {
				...
				this.field3541.put((long) var8, var9, arg0 - 250);
			}
		}
		field3543++;
	}
			...
			if (class117.loginStep == 8) {
				...
				if (class117.loginStep == 9 && class33.loginStream.available(1) >= 9) {
					...
					if (class238.field4430 == 1) {
						try {
							GZip.field1118.method628(NpcType.field2326.field3599, true);
						} catch (Throwable var10) {
						}
					} else {
						try {
							class180.field3579.method628(NpcType.field2326.field3599, true);
	...
	public final JString method1265(JString arg0, int arg1, int arg2) {
		...
		if (this.field3541 == null) {
			...
			class216 var4 = (class216) this.field3541.find((long) arg2);
	...
	public final int method1267(int arg0, int arg1, int arg2) {
		...
		class192 var4 = (class192) this.field3541.find((long) arg2);
		if (var4 == null) {
			return arg1;
		} else {
			if (arg0 >= -96) {
