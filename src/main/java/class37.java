...
public class class37 {
	...
	public static JString field663 = field668;
	...
	public static final void method248(int arg0, int arg1, int arg2, byte arg3, int arg4) {
		...
		if (HashTable.field2982 && class158.method1069(true, 0, false) == 0) {
			HashTable.field2982 = false;
		}
		if (HashTable.field2982) {
			class72.method478(arg1, arg4, arg0, arg2, 0);
			Client.method221(class242.field4480, false, -22717);
		}
		if (!HashTable.field2982 && !class108.field1960 && arg1 <= var15 && var15 < arg0 + arg1 && arg4 <= var16 && var16 < arg2 + arg4) {
	...
	public static final class169 method250(Js5 arg0, byte arg1, int arg2) {
		field670++;
		if (arg1 != 0) {
			field668 = null;
		}
