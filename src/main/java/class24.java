...
public class class24 {
	...
	private static JString field391 = class208.method1425("Loaded interfaces");
	...
	public static JString field393 = class208.method1425("nicht hergestellt werden)3");

	@OriginalMember(owner = "client!ca", name = "m", descriptor = "Li;")
	private static JString FRIENDCANTADDSELF = class208.method1425("You can(Wt add yourself to your own friend list)3");
	...
	public final void method130(int arg0, long arg1, class145 arg2) {
		if (arg0 == 37) {
			field382++;
			this.field389.put(new class101(arg2), arg1, false);
		}
	}
	...
	public static final void method131(boolean arg0) {
		if (arg0) {
			class62.field1137 = HashTable.field2981;
	...
	public final class145 method135(int arg0, long arg1) {
		if (arg0 >= -96) {
			...
			field387++;
			class101 var4 = (class101) this.field389.find(arg1);
