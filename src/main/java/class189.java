...
public class class189 extends Linkable2 {
	...
	public static final void method1317(byte arg0) {
		...
		int var2 = field3661 - NpcType.field2332;
		if (var2 < 2 || var2 > 2) {
			var2 >>= 0x4;
		}
	...
	public static final void method1321(byte arg0) {
		...
		if (class228.field4278 != 10) {
			...
			if (class228.field4278 == 20) {
				...
				if (class228.field4278 == 90) {
					class12.field175 = new class75(11, true, HashTable.field2977);
					class118.field2149 = new class75(12, true, HashTable.field2977);
					class236.field4399 = new class75(14, true, HashTable.field2977);
					class196.field3764 = new class75(17, true, HashTable.field2977);
					class167.field3207 = new class75(19, true, HashTable.field2977);
					class166.field3201 = new class75(22, true, HashTable.field2977);
					class231.field4327 = new class75(26, true, HashTable.field2977);
					class227.field4252 = new class75(30, true, HashTable.field2977);
		...
		if (var10 >= 0 && var10 < SeqType.field1990 && var11 >= 0 && scene.field760 > var11) {
			class157.field3035 = scene.field760 - var11;
			NpcType.field2332 = var10;
		} else {
			class157.field3035 = class119.field2183 + scene.field760 - var7 * 64;
			NpcType.field2332 = var6 * 64 - class16.field239;
		}
