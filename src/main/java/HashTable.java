...
public class HashTable {
	...
	public static JString field2970 = field2978;
	...
	public final Linkable method1050(byte arg0) {
		...
		if (this.field2991 > 0 && this.buckets[this.field2991 - 1] != this.field2992) {
			Linkable var2 = this.field2992;
			this.field2992 = var2.next;
			return var2;
		}
		while (this.bucketCount > this.field2991) {
			Linkable var3 = this.buckets[this.field2991++].next;
			if (this.buckets[this.field2991 - 1] != var3) {
	...
	public final Linkable find(long key) {
		this.field2987 = key;
	...
	public final void put(long arg0, Linkable arg1, int arg2) {
		...
		field2986++;
		Linkable var5 = this.buckets[(int) (arg0 & (long) (this.bucketCount + arg2))];
		arg1.nodeId = arg0;
		arg1.prev = var5.prev;
		arg1.next = var5;
		arg1.prev.next = arg1;
	...
	public final Linkable method1056(int arg0) {
		...
		Linkable var2 = this.buckets[(int) (this.field2987 & (long) (this.bucketCount - 1))];
		if (arg0 != 3) {
			this.method1050((byte) 76);
		}
		while (this.searchCursor != var2) {
			if (this.searchCursor.nodeId == this.field2987) {
