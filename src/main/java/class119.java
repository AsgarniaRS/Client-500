...
public class class119 {
	...
	public static JString field2158 = class208.method1425("scape main");

	@OriginalMember(owner = "client!kj", name = "h", descriptor = "I")
	public static int field2161 = 0;

	@OriginalMember(owner = "client!kj", name = "c", descriptor = "Li;")
	public static JString field2156 = class208.method1425("und haben es deaktiviert)3 Klicken Sie auf der");

	@OriginalMember(owner = "client!kj", name = "n", descriptor = "Li;")
	public static JString field2167 = class208.method1425("Starte 3D)2Softwarebibliothek)3");

	@OriginalMember(owner = "client!kj", name = "t", descriptor = "Li;")
	public static JString field2173 = class208.method1425(")2");
	...
	private void method809(int arg0) throws IOException {
		field2181++;
	...
	private void method811(int arg0) throws IOException {
		this.field2159 = 0;
		if (this.field2178 != this.field2166) {
			this.field2164.method444(1, this.field2166);
			this.field2178 = this.field2166;
	...
	private File method815(byte arg0) {
	...
	public static final void method816(int arg0, byte arg1, Js5Local arg2) {
		field2155++;
		if (class79.masterIndexBuffer == null) {
			class188.queueRequest(null, 255, 255, arg1, -439631408, 0, true);
			class10.field141[arg0] = arg2;
		} else {
			class79.masterIndexBuffer.pos = arg0 * 8 + 5;
			int var3 = class79.masterIndexBuffer.g4();
			int var4 = class79.masterIndexBuffer.g4();
