...
public class class209 {
	...
	public static JString field3972 = field3974;
	...
	public final class30 method1430(byte arg0, SeqType arg1, int arg2) {
		field3966++;
		if (this.field3977 != -1) {
			return class147.list(this.field3977).method866(arg2, 0, arg1);
		}
		if (arg0 != 113) {
		...
		if (var4 == null) {
			...
			var4 = var10.light(64, 768, -50, -10, -50);
	...
	private void method1431(int arg0) {
		field3963++;
	...
	public final class30 method1432(SeqType arg0, int arg1, int arg2, int arg3, SeqType arg4) {
		field3979++;
		if (this.field3977 != -1) {
			return class147.list(this.field3977).method867(0, arg0, arg3, arg2, arg4);
		}
		...
		if (var10 == null) {
			...
			if (var10 == null) {
				...
				var10 = var25.light(64, 850, -30, -50, -30);
