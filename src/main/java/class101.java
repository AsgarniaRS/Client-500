...
public class class101 extends Linkable2 {
	...
	public static final class7 method706(int arg0, boolean arg1) {
		field1830++;
		class7 var2 = (class7) class12.field174.find((long) arg0);
		if (var2 != null) {
			return var2;
		} else if (arg1) {
			byte[] var3 = class139.field2580.getFile(arg0, 4);
			class7 var4 = new class7();
			if (var3 != null) {
				var4.method38(73, new Packet(var3), arg0);
			}
			class12.field174.put(var4, (long) arg0, false);
			return var4;
		} else {
			return null;
		}
