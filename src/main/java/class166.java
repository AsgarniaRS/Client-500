...
public class class166 {
	...
	public static final void method1144(int arg0, Color arg1, JString arg2, boolean arg3, int arg4) {
		try {
			Graphics var5 = HashTable.field2977.getGraphics();
			if (class15.field228 == null) {
				class15.field228 = new Font("Helvetica", 1, 13);
				class201.field3842 = HashTable.field2977.getFontMetrics(class15.field228);
			}
			if (arg3) {
			...
			try {
				if (class143.field2645 == null) {
					class143.field2645 = HashTable.field2977.createImage(304, 34);
				}
