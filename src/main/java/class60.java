		...
		if (~IfType.field3447 > -51) {
			if (arg5.sound != null && arg5.sound.length >= 1 && ~arg3 > ~arg5.sound.length && arg5.sound[arg3] != null) {
				...
				if (var10 == 0) {
					...
					class25.field397[IfType.field3447] = var8;
					class110.field2018[IfType.field3447] = var9;
					class8.field116[IfType.field3447] = 0;
					int var12 = (arg4 + -64) / 128;
					class237.field4419[IfType.field3447] = null;
					int var13 = (arg2 + -64) / 128;
					class145.field2728[IfType.field3447] = (var12 << 16) - -(var13 << 8) + var10;
					++IfType.field3447;
				}
			}
		}
