...
public class ModelUnlit extends class145 {
	...
	private static int method543(int[][] arg0, int arg1, int arg2) {
		int var3 = arg1 >> 7;
		int var4 = arg2 >> 7;
	...
	public final class30 light(int arg0, int arg1, int arg2, int arg3, int arg4) {
	...
	private void method550(int arg0) {
	...
	private void loadOb3(byte[] src) {
		...
		for (int var73 = 0; var73 < var11; var73++) {
			...
			if (var74 == 0) {
				...
				this.field1477[var73] = (short) var2.g2();
			}
			if (var74 == 1) {
				this.field1501[var73] = (short) var3.g2();
				this.field1495[var73] = (short) var3.g2();
				this.field1477[var73] = (short) var3.g2();
	...
	public final class145 method559(int arg0, int arg1, int arg2) {
		return this.light(this.field1498, this.field1523, arg0, arg1, arg2);
	}
	...
	private void method560(int arg0) {
		int var2 = field1481[arg0];
		int var3 = field1509[arg0];
		for (int var4 = 0; var4 < this.field1489; var4++) {
	...
	private void method562(int[][] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
		boolean var7 = false;
		boolean var8 = false;
		boolean var9 = false;
		int var10 = -arg4 / 2;
	...
	private int method567(ModelUnlit arg0, int arg1) {
		int var3 = -1;
	...
	private void method571(byte[] arg0) {
		boolean var2 = false;
		boolean var3 = false;
