...
public class class70 {
    ...
    @OriginalMember(owner = "client!gd", name = "e", descriptor = "Ljava/util/Random;")
    public static Random field1259 = new Random();
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IIIIBII)I")
    public static final int method469(int arg0, int arg1, int arg2, int arg3, byte arg4, int arg5, int arg6) {
        field1263++;
        if ((arg6 & 0x1) == 1) {
            int var7 = arg0;
            arg0 = arg5;
        ...
        if (var8 == 0) {
            ...
            return var8 == 2 ? 1 + 7 - arg0 - arg3 : -arg5 + 8 + -arg2;
        }
    }

    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(II)I")
    public static int method470(int arg0, int arg1) {
        return arg0 & arg1;
    }
}
