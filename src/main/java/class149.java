...
public class class149 extends Linkable2 {
	...
	public static Packet incomingBuffer;
	...
	public static final void method1007(int arg0, int arg1) {
		...
		if (!IfType.openInterface(arg0, 0)) {
			return;
		}
		IfType[] var2 = class78.list[arg0];
	...
	public final class125 method1010(boolean arg0) {
		field2880++;
		ModelUnlit var2 = ModelUnlit.load(class156.field3010, this.field2864, 0);
		if (var2 == null) {
			return null;
		}
		...
		if (this.field2892 != 128 || this.field2845 != 128 || this.field2873 != 128) {
			var5.resize(this.field2892, this.field2845, this.field2873);
		}
		return var5;
	}
	...
	public final JString method1011(JString arg0, byte arg1, int arg2) {
		...
		class216 var4 = (class216) this.field2871.find((long) arg2);
	...
	public final int method1012(boolean arg0, int arg1, int arg2) {
		...
		class192 var4 = (class192) this.field2871.find((long) arg1);
	...
	public final ModelUnlit method1013(boolean arg0, int arg1) {
		...
		ModelUnlit var7 = ModelUnlit.load(class156.field3010, var3, 0);
		if (var6 != -1) {
			ModelUnlit var8 = ModelUnlit.load(class156.field3010, var6, 0);
			if (var4 == -1) {
				ModelUnlit[] var9 = new ModelUnlit[]{var7, var8};
				var7 = new ModelUnlit(var9, 2);
			} else {
				ModelUnlit var10 = ModelUnlit.load(class156.field3010, var4, 0);
	...
	public final boolean method1017(boolean arg0, int arg1) {
		...
		boolean var6 = true;
		if (!class156.field3010.requestDownload(var3, 0)) {
			var6 = false;
		}
		if (var4 != -1 && !class156.field3010.requestDownload(var4, 0)) {
			var6 = false;
		}
		return var6;
	}
	...
	public final ModelUnlit method1018(byte arg0, boolean arg1) {
		...
		ModelUnlit var5 = ModelUnlit.load(class156.field3010, var3, 0);
		if (var4 != -1) {
			ModelUnlit var6 = ModelUnlit.load(class156.field3010, var4, 0);
	...
	public final boolean method1024(boolean arg0, byte arg1) {
		...
		boolean var7 = true;
		if (!class156.field3010.requestDownload(var4, 0)) {
			var7 = false;
		}
		if (var3 != -1 && !class156.field3010.requestDownload(var3, 0)) {
			var7 = false;
		}
		if (var5 != -1 && !class156.field3010.requestDownload(var5, 0)) {
			var7 = false;
		}
		return var7;
	}
	...
	public static final void method1025(boolean arg0, int arg1) {
		...
		for (int var2 = 0; var2 < class55.field1041; var2++) {
			...
			if (var3 != null && var3.method287(-1) && arg0 == var3.field3684.alwaysontop && var3.field3684.isMultiNpcVisible()) {
	...
	private void method1026(int arg0, byte arg1, Packet arg2) {
		if (arg0 == 1) {
			...
			this.field2875 = arg2.g2();
		} else if (arg0 == 6) {
			this.field2874 = arg2.g2();
		} else if (arg0 == 7) {
			this.field2878 = arg2.g2();
			if (this.field2878 > 32767) {
				this.field2878 -= 65536;
			}
		} else if (arg0 == 8) {
			this.field2872 = arg2.g2();
			...
			this.field2856 = arg2.g4();
		} else if (arg0 == 16) {
			this.field2879 = true;
		} else if (arg0 == 23) {
			this.field2890 = arg2.g2();
			this.field2859 = arg2.g1();
		} else if (arg0 == 24) {
			this.field2877 = arg2.g2();
		} else if (arg0 == 25) {
			this.field2855 = arg2.g2();
			this.field2881 = arg2.g1();
		} else if (arg0 == 26) {
			this.field2882 = arg2.g2();
		} else if (arg0 >= 30 && arg0 < 35) {
			this.field2900[arg0 - 30] = arg2.gjstr();
			if (this.field2900[arg0 - 30].equalsIgnoreCase(class192.HIDDEN)) {
			...
			for (int var17 = 0; var17 < var16; var17++) {
				this.field2857[var17] = (short) arg2.g2();
				this.field2851[var17] = (short) arg2.g2();
			}
		} else if (arg0 == 41) {
			int var4 = arg2.g1();
			...
			for (int var5 = 0; var5 < var4; var5++) {
				this.field2865[var5] = (short) arg2.g2();
				this.field2839[var5] = (short) arg2.g2();
			}
		} else if (arg0 == 42) {
			int var14 = arg2.g1();
			...
			this.field2844 = arg2.g2();
		} else if (arg0 == 79) {
			this.field2860 = arg2.g2();
		} else if (arg0 == 90) {
			this.field2850 = arg2.g2();
		} else if (arg0 == 91) {
			this.field2893 = arg2.g2();
		} else if (arg0 == 92) {
			this.field2840 = arg2.g2();
		} else if (arg0 == 93) {
			this.field2867 = arg2.g2();
		} else if (arg0 == 95) {
			this.field2849 = arg2.g2();
		} else if (arg0 == 96) {
			this.field2852 = arg2.g1();
		} else if (arg0 == 97) {
			this.field2843 = arg2.g2();
		} else if (arg0 == 98) {
			this.field2869 = arg2.g2();
		} else if (arg0 >= 100 && arg0 < 110) {
			if (this.field2905 == null) {
				this.field2847 = new int[10];
				this.field2905 = new int[10];
			}
			this.field2905[arg0 - 100] = arg2.g2();
			this.field2847[arg0 - 100] = arg2.g2();
		} else if (arg0 == 110) {
			this.field2892 = arg2.g2();
		} else if (arg0 == 111) {
			this.field2845 = arg2.g2();
		} else if (arg0 == 112) {
			...
			this.field2876 = arg2.g2();
		} else if (arg0 == 122) {
			this.field2886 = arg2.g2();
		} else if (arg0 == 124) {
			...
			if (this.field2871 == null) {
				...
				this.field2871 = new HashTable(var7);
			}
	...
	public final class30 method1027(int arg0, int arg1, int arg2, SeqType arg3) {
		...
		if (var7 == null) {
			ModelUnlit var8 = ModelUnlit.load(class156.field3010, this.field2864, 0);
			if (var8 == null) {
				return null;
			}
			if (this.field2857 != null) {
			...
			var7 = var8.light(this.field2868 + 64, this.field2842 + 768, -50, -10, -50);
			if (this.field2892 != 128 || this.field2845 != 128 || this.field2873 != 128) {
				var7.resize(this.field2892, this.field2845, this.field2873);
			}
			var7.field494 = true;
