...
public class class149 extends class136 {
    ...
    public final boolean method1017(boolean arg0, int arg1) {
        ...
        boolean var6 = true;
        if (!class156.field3010.download(var3, 0)) {
            var6 = false;
        }
        if (var4 != -1 && !class156.field3010.download(var4, 0)) {
            var6 = false;
        }
        return var6;
    }
    ...
    public final boolean method1024(boolean arg0, byte arg1) {
        ...
        boolean var7 = true;
        if (!class156.field3010.download(var4, 0)) {
            var7 = false;
        }
        if (var3 != -1 && !class156.field3010.download(var3, 0)) {
            var7 = false;
        }
        if (var5 != -1 && !class156.field3010.download(var5, 0)) {
            var7 = false;
        }
        return var7;
    }
