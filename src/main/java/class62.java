...
public class class62 extends class23 {
	...
	public static final class33 method441(int arg0, byte arg1) {
		...
		++field1138;
		class33 var2 = (class33) ClientStream.field2535.find((long) arg0);
		if (var2 != null) {
			return var2;
		} else {
			byte[] var3 = GZip.field1114.getFile(class118.method801(arg0, false), class142.method930(100, arg0));
			class33 var4 = new class33();
			var4.field539 = arg0;
			if (var3 != null) {
				var4.method211(new Packet(var3), (byte) 12);
			}
			ClientStream.field2535.put(var4, (long) arg0, false);
			return var4;
		}
	}
