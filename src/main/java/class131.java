...
public class class131 {
    ...
    public static JString field2448 = class208.method1425("Lade Schrifts-=tze )2 ");

    @OriginalMember(owner = "client!m", name = "j", descriptor = "Li;")
    public static JString field2454 = class208.method1425("Update)2Liste geladen)3");
