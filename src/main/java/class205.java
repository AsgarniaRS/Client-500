...
public class class205 extends Linkable2 {
	...
	private static JString field3916 = class208.method1425("Existing User");
	...
	private void method1410(byte arg0, Packet arg1, int arg2) {
		if (arg2 == 1) {
	...
	public static final IfType method1415(byte arg0, IfType arg1) {
		field3914++;
		if (arg1.layerId != -1) {
			return IfType.get(-64, arg1.layerId);
		}
