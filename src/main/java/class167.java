...
public class class167 extends class23 {
	...
	public static final void method1146(byte arg0) {
		for (int var1 = 0; ~class55.field1041 < ~var1; ++var1) {
			...
			if (var4 != null) {
				class77.method514(var4.field3684.size, var4, 24550);
			}
		}
	...
	private void method1148(int arg0, int arg1, int arg2, int arg3) {
		++field3214;
		if (arg2 != 6) {
			open = null;
		}
	...
	private void method1149(int arg0, int arg1, int arg2, int arg3) {
		++field3206;
	...
	public static final EnumType method1150(int arg0, int arg1) {
		EnumType var2 = (EnumType) class1.field2.find((long) arg0);
		if (arg1 > -107) {
			field3218 = null;
		}
		++field3227;
		if (var2 != null) {
			...
			byte[] var3 = class202.field3851.getFile(class201.method1381(arg0, 255), class188.method1316((byte) 52, arg0));
			EnumType var4 = new EnumType();
			if (var3 != null) {
				var4.decode(new Packet(var3));
			}
			class1.field2.put(var4, (long) arg0, false);
			return var4;
		}
	}
}
