...
public class class147 {
	...
	public static final int method986() {
		return class190.field3670;
	}

	@OriginalMember(owner = "client!ne", name = "a", descriptor = "(II)Llf;")
	public static final NpcType list(int id) {
		NpcType cached = (NpcType) class231.recentUse.find((long) id);
		if (cached != null) {
			return cached;
		}

		byte[] buf = class209.configClient.getFile(Ground.method387(id, (byte) -82), class101.method704(id, -321617529));
		...
		class231.recentUse.put(npc, id, false);
		return npc;
	}
