...
public class class244 extends Linkable {
			...
			if (class238.packetType == 99) {
				...
				if (var130 >= 0 && var129 >= 0 && var130 < 104 && var129 < 104) {
					...
					if (class240.field4458.field4089[0] >= var130 - var136 && var130 + var136 >= class240.field4458.field4089[0] && var129 - var136 <= class240.field4458.field4143[0] && class240.field4458.field4143[0] <= var129 + var136 && class223.field4213 != 0 && var133 > 0 && IfType.field3447 < 50 && var131 != -1) {
						...
						class145.field2728[IfType.field3447] = (var130 << 16) + (var129 << 8) + var135;
						IfType.field3447++;
					}
				}
			}
	...
	public static final void method1602(class218 arg0, int arg1) {
		...
		if (arg0 instanceof class191) {
			var10 = ((class191) arg0).field3684.walksmooth;
		}
		if (var10) {
		...
		for (int var9 = 0; var9 < class172.field3347; var9++) {
			...
			if (var14 == 0) {
				for (int var15 = 0; var15 < var12; var15++) {
					var13[var15] = var2.g1b();
				}
			} else if (var14 == 1) {
				for (int var16 = 0; var16 < var11; var16++) {
					for (int var17 = 0; var17 < var10; var17++) {
						var13[var11 * var17 + var16] = var2.g1b();
					}
				}
			}
		}
