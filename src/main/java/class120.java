...
public class class120 extends class23 {
	...
	public static JString CHATCOMMAND = class208.method1425("::");
	...
	public static JString field2201 = class208.method1425("<)4col>");
	...
	private void method823(int arg0) {
		if (arg0 < 114) {
			this.field2190 = null;
		}
	...
	public static final int method825(JString arg0, int arg1) {
		...
		if (arg0 == null) {
			...
			for (int var3 = 0; var3 < Isaac.field2731; ++var3) {
				if (arg0.equalsIgnoreCase(class23.field370[var3])) {
					return var3;
				}
			}
			return -1;
