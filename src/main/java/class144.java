...
public abstract class class144 {
    ...
    @OriginalMember(owner = "client!nb", name = "n", descriptor = "[Lja;")
    private class99[] field2675;
    ...
    private Object[][] field2702;

    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(II)V")
    public void method110(int arg0, int arg1) {
        if (arg0 == -23896) {
            field2662++;
        }
    }
    ...
    public final byte[] method941(byte arg0, int arg1, int arg2) {
        if (arg0 != 56) {
            this.method950(-5, -21);
        }
        field2700++;
        return this.method951(-14531, null, arg2, arg1);
    }
    ...
    public final void method943(int arg0) {
        field2703++;
        for (int var2 = arg0; var2 < this.field2702.length; var2++) {
            this.field2702[var2] = null;
        }
    }
    ...
    public static final boolean method947(int arg0, int arg1, int arg2, int arg3) {
        ...
        if (arg3 < 16) {
            if (arg3 == 1) {
                if (var4 > class74.field1353) {
                    if (!class104.method720(var4, var6, var5)) {
                        return false;
                    }
                    if (!class104.method720(var4, var6, var5 + 128)) {
                        return false;
                    }
                }
                if (arg0 > 0) {
                    if (!class104.method720(var4, var7, var5)) {
                        return false;
                    }
                    if (!class104.method720(var4, var7, var5 + 128)) {
                        return false;
                    }
                }
                if (!class104.method720(var4, var8, var5)) {
                    return false;
                }
                if (!class104.method720(var4, var8, var5 + 128)) {
                    return false;
                }
                return true;
            }
            if (arg3 == 2) {
                if (var5 < class216.field4050) {
                    if (!class104.method720(var4, var6, var5 + 128)) {
                        return false;
                    }
                    if (!class104.method720(var4 + 128, var6, var5 + 128)) {
                        return false;
                    }
                }
                if (arg0 > 0) {
                    ...
                    if (!class104.method720(var4 + 128, var7, var5 + 128)) {
                        return false;
                    }
                }
                if (!class104.method720(var4, var8, var5 + 128)) {
                ...
                if (!class104.method720(var4 + 128, var8, var5 + 128)) {
                    return false;
                }
                return true;
            }
            if (arg3 == 4) {
                if (var4 < class74.field1353) {
                    if (!class104.method720(var4 + 128, var6, var5)) {
                        return false;
                    }
                    if (!class104.method720(var4 + 128, var6, var5 + 128)) {
                        return false;
                ...
                if (arg0 > 0) {
                    if (!class104.method720(var4 + 128, var7, var5)) {
                        return false;
                    }
                    if (!class104.method720(var4 + 128, var7, var5 + 128)) {
                        return false;
                ...
                if (!class104.method720(var4 + 128, var8, var5)) {
                    return false;
                }
                if (!class104.method720(var4 + 128, var8, var5 + 128)) {
                    return false;
        ...
        if (!class104.method720(var4 + 64, var9, var5 + 64)) {
            return false;
        } else if (arg3 == 16) {
            return class104.method720(var4, var8, var5 + 128);
        } else if (arg3 == 32) {
            return class104.method720(var4 + 128, var8, var5 + 128);
        } else if (arg3 == 64) {
            return class104.method720(var4 + 128, var8, var5);
        } else if (arg3 == 128) {
            return class104.method720(var4, var8, var5);
        } else {
            return true;
        }
    }
    ...
    public final boolean method948(int arg0, class88 arg1, class88 arg2) {
        ...
        field2673++;
        int var6 = this.field2690.method693(var4.method605((byte) -62), 3598);
        if (!this.method970(121, var6)) {
            return false;
        }
        int var7 = this.field2675[var6].method693(var5.method605((byte) -42), 3598);
        if (arg0 <= 111) {
            this.field2684 = null;
        }
        return this.method961(var6, var7, (byte) 121);
    }

    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(III)[B")
    public final byte[] method949(int arg0, int arg1, int arg2) {
        field2711++;
        if (!this.method945(arg0, 29, arg2)) {
            return null;
        }
        if (this.field2702[arg2] == null || this.field2702[arg2][arg0] == null) {
            boolean var4 = this.method953(arg2, null, (byte) -31);
            if (!var4) {
                this.method112(arg2, true);
                boolean var5 = this.method953(arg2, null, (byte) -86);
                if (!var5) {
                    return null;
                }
            }
        }
        byte[] var6 = class67.method457(false, this.field2702[arg2][arg0], 0);
        if (arg1 != -6) {
            this.field2690 = null;
        }
        return var6;
    ...
    public final int[] method950(int arg0, int arg1) {
        field2707++;
        if (!this.method970(121, arg1)) {
            return null;
        }
        int[] var3 = this.field2680[arg1];
        if (arg0 < 12) {
            this.field2670 = null;
        }
        if (var3 == null) {
            var3 = new int[this.field2685[arg1]];
            int var4 = 0;
    ...
    public final byte[] method951(int arg0, int[] arg1, int arg2, int arg3) {
        field2674++;
        if (!this.method945(arg3, 37, arg2)) {
            return null;
        }
        if (this.field2702[arg2] == null || this.field2702[arg2][arg3] == null) {
            boolean var5 = this.method953(arg2, arg1, (byte) -122);
            if (!var5) {
                this.method112(arg2, true);
                boolean var6 = this.method953(arg2, arg1, (byte) -57);
                if (!var6) {
                    return null;
                }
            }
        }
        byte[] var7 = class67.method457(false, this.field2702[arg2][arg3], 0);
        if (this.field2706) {
            this.field2702[arg2][arg3] = null;
            if (this.field2676[arg2] == 1) {
                this.field2702[arg2] = null;
            }
        }
        if (arg0 != -14531) {
            this.method946(null, -45);
        }
        return var7;
    }

    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Z)I")
    public final int method952(boolean arg0) {
        field2689++;
        if (arg0) {
            return 104;
        }
        ...
        for (int var4 = 0; var4 < this.field2708.length; var4++) {
            if (this.field2685[var4] > 0) {
                var3 += this.method116((byte) 17, var4);
                var2 += 100;
            }
        }
        if (var2 == 0) {
    ...
    private final boolean method953(int arg0, int[] arg1, byte arg2) {
        ...
        if (!this.method970(120, arg0)) {
            ...
            int var4 = this.field2685[arg0];
            int[] var5 = this.field2680[arg0];
            if (this.field2702[arg0] == null) {
                this.field2702[arg0] = new Object[this.field2676[arg0]];
            }
            boolean var6 = true;
            Object[] var7 = this.field2702[arg0];
            ...
            if (var4 > 1) {
                ...
                for (int var28 = 0; var28 < var4; var28++) {
                    ...
                    if (this.field2706) {
                        ...
                        var7[var29] = class168.method1155(false, (byte) -107, var22[var28]);
                    }
                }
            } else {
                int var30;
                ...
                if (this.field2706) {
                    ...
                    var7[var30] = class168.method1155(false, (byte) -126, var12);
                }
            }
            return true;
        }
    ...
    public static final class88 method954(long arg0, int arg1, int arg2, int[] arg3) {
        ...
        int var6 = 96 % ((arg1 - 61) / 38);
        return arg2 == 5 ? class200.method1377(arg0, (byte) 71).method614((byte) 83) : class234.method1558(95, arg0);
    }

    @OriginalMember(owner = "client!nb", name = "d", descriptor = "(II)Z")
    public final boolean method955(int arg0, int arg1) {
        field2688++;
        if (this.field2676.length == 1) {
            return this.method961(0, arg1, (byte) 110);
        } else if (arg0 != 0) {
            return false;
        } else if (!this.method970(arg0 + 123, arg1)) {
            return false;
        } else if (this.field2676[arg1] == 1) {
            return this.method961(arg1, 0, (byte) 104);
        } else {
    ...
    public final boolean method956(int arg0, class88 arg1) {
        ...
        int var5 = this.field2690.method693(var4.method605((byte) -31), 3598);
        return this.method972(var5, (byte) -68);
    }

    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(BI)I")
    public int method116(byte arg0, int arg1) {
        field2696++;
        if (this.method970(arg0 ^ 0x6B, arg1)) {
            if (arg0 != 17) {
                this.method967(false, false, 70);
            }
            return this.field2708[arg1] == null ? 0 : 100;
        } else {
            return 0;
        }
    }
    ...
    public final void method957(int arg0, byte arg1) {
        field2677++;
        if (this.method970(127, arg0)) {
            int var3 = -59 / ((arg1 - 67) / 41);
            this.field2702[arg0] = null;
        }
    }
    ...
    public final byte[] method958(int arg0, int arg1) {
        field2705++;
        if (this.field2676.length == 1) {
            return this.method941((byte) 56, arg0, 0);
        } else if (!this.method970(120, arg0)) {
            return null;
        } else if (this.field2676[arg0] == 1) {
            return this.method941((byte) 56, 0, arg0);
        } else if (arg1 == 0) {
            throw new RuntimeException();
        } else {
            return null;
    ...
    public final int method959(class88 arg0, byte arg1) {
        ...
        field2682++;
        int var4 = this.field2690.method693(var3.method605((byte) -31), arg1 ^ 0xE7A);
    ...
    public final boolean method961(int arg0, int arg1, byte arg2) {
        field2663++;
        if (arg2 <= 59) {
            this.method953(15, null, (byte) -118);
        }
        if (!this.method945(arg1, 124, arg0)) {
            return false;
        } else if (this.field2702[arg0] != null && this.field2702[arg0][arg1] != null) {
            return true;
        } else if (this.field2708[arg0] == null) {
            this.method112(arg0, true);
    ...
    public final byte[] method962(int arg0, class88 arg1, class88 arg2) {
        ...
        int var6 = this.field2690.method693(var4.method605((byte) -37), 3598);
        if (!this.method970(120, var6)) {
            return null;
        }
        int var7 = this.field2675[var6].method693(var5.method605((byte) -51), 3598);
        if (arg0 != 0) {
            field2668 = null;
        }
        return this.method941((byte) 56, var7, var6);
    }

    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(Z)V")
    public static void method963(boolean arg0) {
        field2666 = null;
        field2668 = null;
        if (!arg0) {
            field2715 = null;
    ...
    public final boolean method964(byte arg0) {
        field2686++;
        boolean var2 = true;
        for (int var3 = 0; var3 < this.field2710.length; var3++) {
            int var4 = this.field2710[var3];
            if (this.field2708[var4] == null) {
                this.method112(var4, true);
                if (this.field2708[var4] == null) {
                    var2 = false;
                }
            }
    ...
    public final int method966(class88 arg0, byte arg1) {
        ...
        int var4 = this.field2690.method693(var3.method605((byte) -83), arg1 + 3601);
        return this.method970(121, var4) ? var4 : -1;
    }

    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(ZZI)V")
    public final void method967(boolean arg0, boolean arg1, int arg2) {
        if (arg1) {
            this.field2675 = null;
            this.field2698 = null;
        }
    ...
    public final int method968(class88 arg0, int arg1, int arg2) {
        ...
        int var5 = this.field2675[arg1].method693(var4.method605((byte) -35), 3598);
        if (this.method945(var5, -94, arg1)) {
            if (arg2 < 53) {
                this.method970(68, 100);
            }
            return var5;
        } else {
            return -1;
    ...
    public final void method969(byte[] arg0, boolean arg1) {
        ...
        this.field2676 = new int[var7 + 1];
        this.field2680 = new int[var7 + 1][];
        this.field2702 = new Object[var7 + 1][];
        this.field2692 = new int[var7 + 1];
        this.field2708 = new Object[var7 + 1];
        this.field2685 = new int[var7 + 1];
        this.field2670 = new int[var7 + 1];
        if (var6 != 0) {
            this.field2684 = new int[var7 + 1];
        ...
        while (this.field2701 > var14) {
            int var21 = this.field2710[var14];
            ...
            this.field2676[var21] = var24 + 1;
            if (var24 + 1 == var22) {
                this.field2680[var21] = null;
            }
            var14++;
        }
        if (var6 == 0) {
        ...
        this.field2698 = new int[var7 + 1][];
        this.field2675 = new class99[var7 + 1];
        for (int var15 = 0; var15 < this.field2701; var15++) {
            int var16 = this.field2710[var15];
            int var17 = this.field2685[var16];
            this.field2698[var16] = new int[this.field2676[var16]];
            for (int var18 = 0; var18 < this.field2676[var16]; var18++) {
                this.field2698[var16][var18] = -1;
            }
            for (int var19 = 0; var19 < var17; var19++) {
                int var20;
                if (this.field2680[var16] == null) {
                    var20 = var19;
                } else {
    ...
    public final boolean method970(int arg0, int arg1) {
        field2681++;
        if (arg0 < 118) {
            return false;
        } else if (arg1 >= 0 && arg1 < this.field2676.length && this.field2676[arg1] != 0) {
            return true;
        } else if (class35.field615) {
    ...
    public final void method971(class88 arg0, int arg1) {
        ...
        field2697++;
        int var4 = this.field2690.method693(var3.method605((byte) -32), 3598);
        this.method110(-23896, var4);
    }
    ...
    public final boolean method972(int arg0, byte arg1) {
        field2693++;
        if (!this.method970(120, arg0)) {
            return false;
        } else if (this.field2708[arg0] == null) {
