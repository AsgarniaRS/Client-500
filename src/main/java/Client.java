...
public class Client extends GameShell {
	...
	public static JString field570 = class208.method1425("underlay)3dat");
	...
	private void method213(int arg0) {
		...
		try {
			if (class244.field4495 == 0) {
				class62.field1151 = NpcType.field2326.method1290(class95.field1761, class168.field3248, arg0 ^ 0x5A);
				class244.field4495++;
			}
			...
			if (class244.field4495 == 2) {
				class190.field3682 = new ClientStream((Socket) class62.field1151.field3131, NpcType.field2326);
	...
	public final void method214(int arg0) {
		...
		class143.method937((byte) 48, HashTable.field2977);
		SeqType.method750(HashTable.field2977, arg0 ^ 0x66);
		class167.field3224 = class35.method235((byte) 117);
		if (class167.field3224 != null) {
			class167.field3224.method173(64, HashTable.field2977);
		}
		Ground.field941 = class181.field3581;
		try {
			if (NpcType.field2326.field3592 != null) {
				class18.field299 = new class119(NpcType.field2326.field3592, 5200, 0);
				for (int var2 = 0; var2 < 27; var2++) {
					class246.field4506[var2] = new class119(NpcType.field2326.field3586[var2], 6000, 0);
				}
				class104.field1894 = new class119(NpcType.field2326.field3584, 6000, 0);
				class167.field3225 = new class222(255, class18.field299, class104.field1894, 500000);
				class175.field3531 = new class119(NpcType.field2326.field3590, 24, 0);
				NpcType.field2326.field3586 = null;
				NpcType.field2326.field3584 = null;
				NpcType.field2326.field3590 = null;
				NpcType.field2326.field3592 = null;
			}
	...
	public final void init() {
		...
		if (class218.field4136 == null) {
			class218.field4136 = IfType.field3455;
		}
	...
	private void method217(int arg0, int arg1) {
		class62.field1151 = null;
		class244.field4495 = 0;
		class190.field3682 = null;
		if (arg1 != 1) {
	...
	public final void method218(int arg0) {
		...
		if (class167.field3224 != null) {
			class167.field3224.method177(-99999999, HashTable.field2977);
		}
	...
	private void method219(byte arg0) {
		field560++;
		if (class32.field519 == 0) {
			...
			if (var34 == 100) {
				class6.field83 = 20;
				class209.field3965 = ClientScript.field4517;
			...
			class27.field458 = class220.method1485(0, HashTable.field2977, NpcType.field2326, (byte) -120, 22050);
			...
			class114.field2058 = class220.method1485(1, HashTable.field2977, NpcType.field2326, (byte) -23, 2048);
			...
			if (var36 < 6) {
				...
				class6.field83 = 35;
				class32.field519 = 60;
				class209.field3965 = HashTable.field2988;
			}
			...
			class49.field917 = class60.method429(class98.field1795, class226.field4245, IfType.field3455, -118, class199.field3797);
			HashTable.field2968 = (class41) class49.field917;
			class3.field30 = class60.method429(class98.field1795, class226.field4245, IfType.field3455, -91, class158.field3047);
			...
			if (var49 < 1000) {
				...
				class189.method1320(Linkable.field1215, class248.field4552, HashTable.field2968, class233.field4367, (byte) 17);
			...
			if (EnumType.field887 == null) {
				class169 var51 = class9.method49(GZip.field1106, (byte) -123, class226.field4245, IfType.field3455);
				if (var51 != null) {
					var51.method1180();
			...
			if (class240.field4462 == null) {
				class240.field4462 = class147.method983(2, class17.field260, IfType.field3455, class226.field4245);
			} else {
				var50++;
			}
			if (class31.field505 == null) {
				class31.field505 = class3.method15(class1.field7, false, IfType.field3455, class226.field4245);
			} else {
				var50++;
			}
			...
			if (class238.field4427 == null) {
				class238.field4427 = class239.method1584(class98.field1798, true, class226.field4245, IfType.field3455);
			} else {
				var50++;
			}
			if (class130.field2430 == null) {
				class130.field2430 = class239.method1584(class106.field1923, true, class226.field4245, IfType.field3455);
			} else {
				var50++;
			}
			if (class176.field3545 == null) {
				class176.field3545 = class239.method1584(class233.field4369, true, class226.field4245, IfType.field3455);
			} else {
				var50++;
			}
			if (class227.field4259 == null) {
				class227.field4259 = class239.method1584(class142.field2624, true, class226.field4245, IfType.field3455);
			} else {
				var50++;
			}
			if (class113.field2043 == null) {
				class169[] var52 = class3.method15(class39.field690, false, IfType.field3455, class226.field4245);
				if (var52 != null) {
			...
			if (class200.field3828 == null) {
				class200.field3828 = class221.method1492(class237.field4413, IfType.field3455, (byte) -47, class226.field4245);
			} else {
				var50++;
			}
			if (HashTable.field2984 == null) {
				HashTable.field2984 = class239.method1584(class227.field4253, true, class226.field4245, IfType.field3455);
			} else {
				var50++;
			}
			if (class35.field597 == null) {
				class35.field597 = class239.method1584(class115.field2077, true, class226.field4245, IfType.field3455);
			} else {
				var50++;
			}
			if (class7.field106 == null) {
				class7.field106 = class1.method2(class142.field2623, (byte) 124, class226.field4245, IfType.field3455);
			} else {
				var50++;
			}
			if (class34.field587 == null) {
				class34.field587 = class1.method2(class240.field4461, (byte) 126, class226.field4245, IfType.field3455);
			} else {
				var50++;
			}
			var50++;
			if (var50 < 15) {
				...
				class6.field83 = 60;
				class32.field519 = 90;
				ClientScript.field4527 = class31.field505;
			...
			if (class32.field519 == 110) {
				...
				NpcType.field2326.method1289(2, class219.field4145, 10);
				class209.field3965 = class200.field3831;
				class6.field83 = 75;
				class32.field519 = 120;
			} else if (class32.field519 == 120) {
				if (class9.field137.method948(114, HashTable.field2975, IfType.field3455)) {
					class214 var61 = new class214(class9.field137.method962(0, HashTable.field2975, IfType.field3455));
	...
	public static final void method221(JString arg0, boolean arg1, int arg2) {
		...
		NpcType.method863(var3 + var7 + var3, var6 - -var3 + var3, var5 - var3, var4 - var3, (byte) -122);
		if (!arg1) {
			class129.method876(var4, var7, 0, var6, var5);
			return;
		}
		Canvas var8 = HashTable.field2977;
		try {
	...
	private void method223(boolean arg0) {
		if (arg0) {
			field567 = null;
		}
		field558++;
	...
	public final void method225(int arg0) {
		...
		NpcType.method865(arg0 ^ 0xFFFFFF9B);
		...
		ClientScript.method1611((byte) -36);
