...
public class class116 extends class23 {
	...
	public static JString field2091 = class208.method1425("titlebutton");
	...
	public static final void method791(int arg0) {
		...
		if (class58.field1097) {
			...
			if (class229.state == 30) {
				...
				if (ClientScript.field4513[96] || ClientScript.field4513[97] || ClientScript.field4513[98] || ClientScript.field4513[99]) {
				...
				if (class229.state == 30) {
					...
					if (class192.timeoutTimer > 750) {
							...
							if (~class156.field3018 == -1) {
								if (class43.field739 && class248.field4537 >= 5) {
									if (class225.field4231 == class135.field2516 && class18.field305 != class172.field3335) {
										...
										Isaac.out.p4_alt1(class135.field2516.parentId);
						...
						while (class43.method279((byte) 31) && ~class81.field1467 > -129) {
							class242.field4481[class81.field1467] = ClientStream.field2558;
