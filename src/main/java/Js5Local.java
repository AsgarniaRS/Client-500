...
public class Js5Local extends Js5 {
	...
	public static final class176 method106(byte arg0, int arg1) {
		class176 var2 = (class176) class168.field3230.find((long) arg1);
		++field335;
		if (arg0 < 122) {
			method118(-72);
		}
		if (var2 != null) {
			...
			byte[] var3 = class34.field584.getFile(arg1, 26);
			class176 var4 = new class176();
			if (var3 != null) {
				var4.method1266(new Packet(var3), 126);
			}
			class168.field3230.put(var4, (long) arg1, false);
			return var4;
		}
	}
	...
	private void method113(int arg0) {
		++field337;
	...
	public static final class188 method117(int arg0, byte arg1, int arg2, int arg3, boolean arg4, int arg5) {
		...
		class188 var8 = (class188) class206.field3922.find(var6);
		++field341;
		if (var8 != null) {
			return var8;
		} else {
			...
			if (var9 != null && !class173.field3366) {
				class206.field3922.put(var9, var6, false);
			}
			return var9;
		}
	}
