...
public class class168 extends Linkable {
	...
	public static final class205 method1152(byte arg0, int arg1) {
		class205 var2 = (class205) class131.field2449.find((long) arg1);
		if (arg0 != 62) {
		...
		byte[] var3;
		if (arg1 >= 32768) {
			var3 = class36.field633.getFile(arg1 & 0x7FFF, 1);
		} else {
			var3 = class78.field1417.getFile(arg1, 1);
		}
		...
		class131.field2449.put(var4, (long) arg1, false);
		return var4;
	}
