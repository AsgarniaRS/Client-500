...
public class class184 extends class23 {
	...
	public static final void method1299(boolean arg0) {
		...
		for (int var2 = 0; var2 < class167.field3223.length; ++var2) {
			if (class27.field453[var2] != -1 && class167.field3223[var2] == null) {
				class167.field3223[var2] = class27.field451.getFile(0, class27.field453[var2]);
			...
			if (class128.field2404[var2] != -1 && class45.field774[var2] == null) {
				class45.field774[var2] = class27.field451.getFile(class17.mapKeys[var2], class128.field2404[var2], 0);
	...
	public static final void method1300(Js5 arg0, Component arg1, boolean arg2, Js5 arg3) {
		...
		if (!class90.open) {
			...
			class105.field1903 = JString.field1640.method1158();
