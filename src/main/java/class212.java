...
public class class212 extends class23 {
	...
	private int[] method1448(int arg0, byte arg1) {
		++field4029;
		if (arg0 < 0) {
				...
				while (true) {
					...
					if (~arg8 == ~var18 && ~arg1 >= ~var16 && ~var16 > ~(arg1 + 8) && arg4 <= var17 && var17 < arg4 + 8) {
						...
						if (var23 > 0 && var24 > 0 && ~var23 > -104 && var24 < 103) {
							...
							if (!arg7) {
								int var26 = arg5;
								if ((2 & class116.mapl[1][var23][var24]) == 2) {
									var26 = arg5 - 1;
								}
								if (var26 >= 0) {
									var25 = arg2[var26];
	...
	public static final void method1451(int arg0, int arg1, byte arg2, int arg3, boolean arg4) {
		...
		if (arg2 >= 1) {
			if (IfType.openInterface(arg1, 0)) {
				class155.method1057(arg0, (byte) -119, arg4, -1, arg3, class78.list[arg1]);
			}
		}
	}

	@OriginalMember(owner = "client!te", name = "c", descriptor = "(Z)V")
	private void method1452(boolean arg0) {
		++field4024;
	...
	private void method1454(byte arg0) {
