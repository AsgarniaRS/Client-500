...
public class class122 extends class50 {
	...
	public static IfType field2219 = null;

	@OriginalMember(owner = "client!lb", name = "r", descriptor = "Li;")
	private static JString field2227 = class208.method1425("You need a members account to login to this world)3");
	...
	public static final void method829(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, byte arg6) {
		Linkable2.method908(arg3, false);
		++field2231;
		int var7 = 0;
		int var8 = -arg5 + arg3;
		if (~var8 > -1) {
	...
	public static final void method830(int arg0, int arg1, Js5Local arg2, class222 arg3) {
		class90 var4 = new class90();
		var4.field1703 = arg2;
		++field2230;
		var4.nodeId = (long) arg1;
		var4.field1702 = 1;
		if (arg0 != -1) {
			field2228 = null;
		}
	...
	public static final class193[] method832(Js5Index arg0, int arg1, int arg2) {
		...
		if (arg1 != 30675) {
			...
			return !class212.method1453((byte) 53, arg2, arg0) ? null : IfType.method1245((byte) -90);
		}
	}
}
