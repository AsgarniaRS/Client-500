...
public class class165 {
		...
		for (int var10 = 0; var10 < arg0.length; var10++) {
			...
			if (var11 != null && (var11.layerId == arg8 || arg8 == -1412584499 && class179.field3570 == var11)) {
				...
				if (!var11.field3412 || !class71.method475(0, var11)) {
					...
					if (class116.field2105 && (class80.method530(-881710560, var11) != 0 || var11.type == 0) && var15 > 127) {
						var15 = 127;
					}
					if (class179.field3570 == var11) {
						if (arg8 != -1412584499 && !var11.draggablebehavior) {
							class6.field77 = arg7;
							class179.field3566 = arg0;
							class94.field1757 = arg6;
							continue;
						}
						if (!var11.draggablebehavior) {
							var15 = 128;
						}
					...
					if (!var11.field3412 || var23 < var21 && var20 < var22) {
						...
						if (var11.type == 0) {
							...
							method1133(arg0, var23, var20, true, var12, var22, var13 - var11.field3395, -var11.field3417 + var14, var11.parentId, var21);
						...
						if (class113.field2045[var12] || class134.field2505 > 1) {
							...
							if (var11.type != 1) {
								if (var11.type == 2) {
										...
										for (int var31 = 0; var31 < var11.field3503; var31++) {
											...
											if (var11.field3390[var29] > 0) {
												...
												if (var33 + 32 > arg1 && var33 < arg9 && arg2 < var32 + 32 && var32 < arg5 || class135.field2516 == var11 && class18.field305 == var29) {
													class188 var38;
													if (class28.field475 == 1 && class58.field1105 == var29 && class209.field3967 == var11.parentId) {
									...
									if (var11.type == 8 && class36.field635 == var11 && Packet.field859 == class138.field2565) {
										int var84 = 0;
										JString var85 = var11.text;
									...
									if (var11.type == 9) {
										...
										if (var11.lineWidth == 1) {
											class72.method477(var99, var100, var102, var101, var11.colour);
										} else {
											class72.method485(var99, var100, var102, var101, var11.colour, var11.lineWidth);
										}
									}
								}
							}
	...
	private static JString method1141(long arg0, int arg1) {
		field3150++;
