...
public class class217 {
    ...
    public static JString field4071 = class208.method1425(105, "Bitte benutzen Sie eine andere Welt)3");

    @OriginalMember(owner = "client!tj", name = "p", descriptor = "Li;")
    private static JString field4072 = class208.method1425(105, "Unable to connect)3");
