...
public abstract class Js5 {
	...
	public final byte[] getFile(int arg1, int arg2) {
		return this.getFile(null, arg2, arg1);
	}
	...
	public final boolean method948(int arg0, JString arg1, JString arg2) {
		...
		return this.requestDownload(var6, var7);
	}
	...
	public final byte[] getFile(int[] arg1, int arg2, int arg3) {
	...
	public final boolean method955(int arg0, int arg1) {
		...
		if (this.field2676.length == 1) {
			return this.requestDownload(0, arg1);
		} else if (arg0 != 0) {
			return false;
		} else if (!this.method970(arg0 + 123, arg1)) {
			return false;
		} else if (this.field2676[arg1] == 1) {
			return this.requestDownload(arg1, 0);
		} else {
