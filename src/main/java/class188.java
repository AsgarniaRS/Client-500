...
public abstract class class188 extends Linkable2 {
	...
	public static final void queueRequest(Js5Local provider, int groupId, int archive, byte padding, int arg4, int expectedCrc, boolean arg6) {
		...
		class97 pendingUrgentRequest = (class97) class241.pendingUrgentQueue.find(key);
		if (pendingUrgentRequest != null) {
			return;
		}
		class97 var10 = (class97) class151.urgentQueue.find(key);
		if (arg4 != -439631408) {
		...
		class97 var11 = (class97) class205.pendingPrefetchQueue.find(key);
		if (var11 == null) {
			if (!arg6) {
				class97 var12 = (class97) class108.prefetchQueue.find(key);
				if (var12 != null) {
					return;
				}
			}
			...
			if (arg6) {
				...
				class138.field2561.push(request, -20038);
