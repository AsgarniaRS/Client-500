...
public class class57 extends class23 {
	...
	public static JString field1080 = class208.method1425("AUS");

	@OriginalMember(owner = "client!fa", name = "T", descriptor = "Li;")
	private static JString field1078 = class208.method1425("wave:");

	@OriginalMember(owner = "client!fa", name = "Z", descriptor = "Li;")
	public static JString field1084 = class208.method1425("Ein kostenloses Spielkonto erstellen)3");
	...
	public static final void method416(boolean arg0, int arg1, int arg2, class174 arg3, int arg4) {
		...
		if (class116.field2105 && (~class80.method530(-881710560, arg3) != -1 || arg3.type == 0)) {
														...
														if (~arg1 == -21) {
															...
															if (~arg1 != -25) {
																if (arg1 == 25) {
																	...
																	class34.method227((byte) -117, class70.field1304, ClientScript.field4526, class223.field4209);
																} else {
