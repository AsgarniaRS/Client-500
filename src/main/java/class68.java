...
public class class68 implements class61 {
	...
	private class199 method462(int arg0, byte arg1) {
		field1230++;
		class199 var3 = (class199) this.field1232.find((long) arg0);
		if (var3 != null) {
			return var3;
		}
		byte[] var4 = this.field1226.getFile(0, arg0);
		if (arg1 != 72) {
			method463(63);
		}
		if (var4 == null) {
			...
			this.field1232.put(var6, (long) arg0, false);
			return var6;
		}
	}
