...
public class class104 extends class23 {
	...
	private boolean method717(int arg0, byte arg1, int arg2) {
		++field1889;
	...
	public static final void method721(byte arg0, int arg1, int arg2, int arg3, int arg4) {
		...
		if (class228.field4278 < 100) {
			...
			class39.field693 = -((int) ((double) arg1 / GZip.field1110)) + NpcType.field2332;
			int var8 = NpcType.field2332 - (int) ((double) arg1 / GZip.field1110);
			...
			if (arg0 >= 0) {
				...
				int var10 = (int) ((double) arg1 / GZip.field1110) + NpcType.field2332;
	...
	public static final class168 method722(int arg0, int arg1, int arg2, byte arg3) {
		...
		NpcType.method863(EnumType.field889, class237.field4423, class234.field4385, class86.field1549, (byte) -126);
		if (var5 != null) {
	...
	private boolean method724(int arg0, int arg1, int arg2) {
		++field1879;
