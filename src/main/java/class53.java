...
public class class53 implements KeyListener, FocusListener {
	...
	public static JString[] field992 = new JString[]{field988, field995, field981, field970, field987, field977, field996, field978, field980, field989, field991, field985};
	...
	public final synchronized void keyPressed(KeyEvent arg0) {
		...
		if (var3 >= 0) {
			...
			if (class203.field3860 != var4) {
				IfType.field3440[class191.field3683] = var3;
	...
	public static final boolean method389(int arg0, IfType arg1) {
		field972++;
		...
		if (class166.field3190 != null) {
			...
			if (var2 >= 0) {
				...
				if (class203.field3860 != var3) {
					IfType.field3440[class191.field3683] = -1;
	...
	public static final void method391(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
		...
		for (int var8 = -1; var8 < class55.field1041 + class55.field1027; var8++) {
			...
			if (var8 == -1) {
				...
				var24 = class244.field4493[IfType.field3430[var8]];
			}
			if (var24 != null && var24.method287(-1)) {
				if (var24 instanceof class191) {
					NpcType var25 = ((class191) var24).field3684;
					if (var25.multinpc != null) {
						var25 = var25.getMultiNpc();
					}
					if (var25 == null) {
						continue;
					}
				...
				if (var8 >= class55.field1027) {
					NpcType var31 = ((class191) var24).field3684;
					if (var31.multinpc != null) {
						var31 = var31.getMultiNpc();
					}
					if (var31.headicon >= 0 && class130.field2430.length > var31.headicon) {
						class150.method1029(arg6 >> 1, arg4 >> 1, arg3, -4013, var24.method1477(64) + 15, var24, arg2);
						if (class25.field401 > -1) {
							class130.field2430[var31.headicon].method1157(class25.field401 + arg0 - 12, class33.field541 + -30 + arg1);
						}
					}
		...
		for (int var9 = 0; var9 < class105.field1920; var9++) {
			...
			JString var15 = class207.field3935[var9];
	...
	public static final void method393(int arg0, int arg1, byte arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
		field968++;
		if (IfType.openInterface(arg1, 0)) {
			class179.field3566 = null;
			class165.method1133(class78.list[arg1], arg6, arg3, true, arg4, arg0, arg7, arg5, -1, arg8);
			if (arg2 != -39) {
