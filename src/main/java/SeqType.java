...
public class SeqType extends Linkable2 {
	...
	public static final void method745(int arg0, int arg1, int arg2, IfType arg3, byte arg4) {
		if (arg4 != -91) {
	...
	public static final int method749(byte arg0, int arg1, int arg2) {
		field2004++;
		class177 var3 = (class177) class64.field1163.find((long) arg1);
		if (var3 == null) {
			return 0;
		} else {
			if (arg0 != -37) {
	...
	public static final void method757(int arg0, int arg1, int arg2) {
		...
		int var8 = var7 << var5;
		class113.var[var4] = class204.method1405(class70.method470(~var8, class113.var[var4]), class70.method470(var8, arg1 << var5));
	}
