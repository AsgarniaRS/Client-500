...
public class EnumType extends Linkable2 {
	...
	private void decode(Packet buf, int code) {
		if (code == 1) {
			...
			int var4 = buf.g2();
			this.field871 = new HashTable(class184.method1298(true, var4));
	...
	public final int method356(int arg0, int arg1) {
		if (this.field871 == null) {
			...
			class192 var3 = (class192) this.field871.find((long) arg1);
	...
	public static final boolean method358(int arg0, Js5Index arg1, int arg2, int arg3) {
		...
		field880++;
		byte[] var4 = arg1.getFile(arg3, arg2);
		if (var4 == null) {
			return false;
		} else {
	...
	public final JString method360(int arg0, byte arg1) {
		...
		class216 var3 = (class216) this.field871.find((long) arg0);
	...
	public static final void method363(int arg0) {
		...
		IfType var1 = class36.method238(Client.field569, class16.field249, true);
