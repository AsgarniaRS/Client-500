...
public class class222 {
	...
	public static JString field4190 = class208.method1425("Gegenstand f-Ur Mitglieder");
	...
	public static JString field4192 = class208.method1425("<br>(X100(U(Y");
	...
	public static final JString method1496(IfType arg0, byte arg1, int arg2) {
		...
		if (arg0.opNames == null || arg2 >= arg0.opNames.length || arg0.opNames[arg2] == null || arg0.opNames[arg2].method602(113).length() == 0) {
			return class116.field2105 ? class166.method1142(new JString[]{IntHashTable.field1804, class170.method1214(arg2, 115)}, -3) : null;
		} else {
			return arg0.opNames[arg2];
		}
	}

	@OriginalMember(owner = "client!ud", name = "a", descriptor = "(IIIZ[B)Z")
	private boolean method1497(int arg0, int arg1, int arg2, boolean arg3, byte[] arg4) {
		field4193++;
