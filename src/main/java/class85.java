...
public class class85 extends class23 {
	...
	public static JString field1534 = class208.method1425("Bitte warten Sie eine Minute");

	@OriginalMember(owner = "client!hh", name = "W", descriptor = "Li;")
	public static JString field1536 = class208.method1425("Spieler)3 Bitte w-=hlen Sie eine andere Welt)3");

	@OriginalMember(owner = "client!hh", name = "X", descriptor = "Li;")
	public static JString field1537 = class208.method1425("Spielwelt erstellt)3");

	@OriginalMember(owner = "client!hh", name = "ab", descriptor = "Li;")
	private static JString field1540 = class208.method1425("Loaded wordpack");
	...
	private void method578(int arg0) {
		++field1544;
