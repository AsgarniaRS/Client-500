...
public class class15 {
					...
					try {
						...
						if (var8 == 3) {
							...
							if (var21 == null) {
								...
								arg1.p1(1);
								arg1.p8(((Number) var21).longValue());
							} else if (var21 instanceof JString) {
								arg1.p1(2);
								arg1.pjstr((JString) var21, (byte) 0);
							} else {
								arg1.p1(4);
							}
						} else if (var8 == 4) {
	...
	public static final int method72(JString arg0, int arg1) {
		if (arg1 != 1) {
	...
	public static final SeqType method75(int arg0, byte arg1) {
		field230++;
		SeqType var2 = (SeqType) class241.field4473.find((long) arg0);
		if (var2 != null) {
			return var2;
		}
		byte[] var3 = class37.field672.getFile(class9.method50(arg0, (byte) -72), class211.method1443(arg0, true));
		SeqType var4 = new SeqType();
		if (var3 != null) {
			var4.decode(new Packet(var3));
		}
		var4.method759((byte) 62);
		class241.field4473.put(var4, (long) arg0, false);
