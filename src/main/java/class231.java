...
public class class231 extends Linkable2 {
	...
	public static class92 recentUse = new class92(64);
	...
	public final ModelUnlit method1542(int arg0) {
		...
		for (int var3 = 0; var3 < this.field4326.length; var3++) {
			var2[var3] = ModelUnlit.load(class43.field733, this.field4326[var3], 0);
		}
		ModelUnlit var4;
		if (var2.length == 1) {
			var4 = var2[0];
	...
	private void method1543(Packet arg0, boolean arg1, int arg2) {
		field4324++;
		if (!arg1) {
			method1546(-123);
		}
	...
	public final ModelUnlit method1545(boolean arg0) {
		...
		for (int var4 = 0; var4 < 5; var4++) {
			if (this.field4341[var4] != -1) {
				var3[var2++] = ModelUnlit.load(class43.field733, this.field4341[var4], 0);
			}
		}
	...
	public final boolean method1547(byte arg0) {
		...
		while (var3 < 5) {
			if (this.field4341[var3] != -1 && !class43.field733.requestDownload(this.field4341[var3], 0)) {
				var2 = false;
			}
			var3++;
		}
	...
	public final void method1548(int arg0, Packet arg1) {
		field4331++;
		if (arg0 != -1) {
			this.field4338 = null;
		}
	...
	public final boolean method1549(byte arg0) {
		...
		for (int var4 = 0; var4 < this.field4326.length; var4++) {
			if (!class43.field733.requestDownload(this.field4326[var4], 0)) {
				var2 = false;
			}
		}
		return var2;
